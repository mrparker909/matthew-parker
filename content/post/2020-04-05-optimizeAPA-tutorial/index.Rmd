...
```{r echo=TRUE, fig.cap="Plot of single parameter function.", fig.width=5, fig.height=3}
x    = seq(0,6,0.01)
y    = sapply(X=x, FUN=F1)
...
Notice that the maximum is somewhere between $x=3$ and $x=4$, so let's set $x=3.5$ as our starting value. 
